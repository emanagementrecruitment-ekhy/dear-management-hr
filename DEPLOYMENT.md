...
5. Deploy. Railway gives you a `*.up.railway.app` URL — open that on a phone and log in with any seeded account (`ekhy@dearmanagement.id`, `owner@dearmanagement.id`, etc.) or one you add via the app.
