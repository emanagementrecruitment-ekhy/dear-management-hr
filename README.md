...
Production implementation of the `DEAR Management HR.dc.html` design (see `../README.md`,
`../chats/chat1.md`, and `../project/DEAR Management HR.dc.html` at the repo root) — a
...
- **Field staff (STAFF & PR)**: `ekhy@dearmanagement.id` (AR-01, Platinum), `dewi@dearmanagement.id` (AR-02, Silver),
  `bayu@dearmanagement.id` (AR-03, Platinum, supervisor), `sinta@dearmanagement.id` (AR-04, Silver),
  `fajar@dearmanagement.id` (AR-05, Platinum), `lia@dearmanagement.id` (AR-06, Silver) — or their phone numbers.
- **Office (OFFICE)**: `owner@dearmanagement.id` (can approve/reject kasbon), `consultant@dearmanagement.id`,
  `admin@dearmanagement.id` (view + download reports only).
