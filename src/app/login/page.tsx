...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid place-items-center p-5 sm:p-10 ar-glow-corners ar-stars ar-login-rosegold">
      <DesktopStatusBar />
      <div className="w-full max-w-[430px] ar-in">
        <div className="flex flex-col items-center gap-3.5 mb-6">
          <div className="bm-login-badge">
            <Image
              src="/api/brand-logo"
              alt="DEAR Management"
              width={104}
        ...
        <div className="bm-divider-star mb-5">
          <span className="bm-divider-star-mark">▪</span>
        </div>

        <div className="bm-login-card bg-ar-surface rounded-[22px] px-[26px] pt-7 pb-6">
          <div className="grid grid-cols-2 gap-2 p-[5px] bg-ar-surface2 rounded-xl mb-2">
            <button
              ...
              } ${portal === "karyawan" ? "bm-tab-active" : "text-ar-dim"}`}
            >
              STAFF &amp; PR
            </button>
            <button
              ...
              className={`py-[11px] rounded-[9px] text-[11px] font-semibold tracking-[0.14em] uppercase cursor-pointer transition ${
                portal === "pusat" ? "bm-tab-active" : "text-ar-dim"
              }`}
            >
              OFFICE
            </button>
        ...
        <div className="mt-7 text-center">
          <div className="text-[10px] tracking-[0.32em] uppercase bm-shimmer-rosegold font-semibold">
            HOME ENTERTAINMENT
          </div>
        ...
        <div className="mt-2.5 text-center text-[9px] text-ar-faint opacity-70">
          DEAR Management Desktop untuk Admin/Owner/Consultant/Kepala Mess — bisa dipakai offline saat internet kantor mati.
        </div>
